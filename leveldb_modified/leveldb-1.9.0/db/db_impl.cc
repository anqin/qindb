...
#include "thirdparty/leveldb-1.9.0/include/leveldb/cleaner.h"
...
Status DBImpl::DoCompactionWork(CompactionState* compact) {
  ...
  for (; input->Valid() && !shutting_down_.Acquire_Load(); ) {
    ...
    } else if (options_.cleaner) {
        Log(options_.info_log, "[qindb] compaction activates the cleaner");
        options_.cleaner->Clean(key, input->value());
    }
